...
# Place Pads
place_pad -row IO_NORTH -location [calc_horizontal_pad_location  0] {sg13g2_IOPadIOVss_1} -master sg13g2_IOPadIOVss
place_pad -row IO_NORTH -location [calc_horizontal_pad_location  1] {sg13g2_IOPadIOVdd_1} -master sg13g2_IOPadIOVdd

place_pad -row IO_WEST -location [calc_vertical_pad_location  5] {sg13g2_miso} 
place_pad -row IO_WEST -location [calc_vertical_pad_location  4] {sg13g2_clk} 
place_pad -row IO_WEST -location [calc_vertical_pad_location  3] {sg13g2_rst} 
place_pad -row IO_WEST -location [calc_vertical_pad_location  2] {sg13g2_sck}
place_pad -row IO_WEST -location [calc_vertical_pad_location  1] {sg13g2_mosi}
place_pad -row IO_WEST -location [calc_vertical_pad_location  0] {sg13g2_ss}
